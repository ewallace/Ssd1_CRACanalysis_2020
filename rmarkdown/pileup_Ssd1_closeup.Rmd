...
Pileup plots for Ssd1 CRAC data. These show detailed profiles of read counts, including nucleotide-specific mutations and deletions, along selected transcripts. Search for instances of the `CNYUCNYU` Ssd1-enriched element in those transcripts, and the `CCAACU` upstream motif.
...
ggsave(plot = pileup_plot_reproducible_4genes, 
       filename = "pileup_plot_reproducible_4genes.pdf",
