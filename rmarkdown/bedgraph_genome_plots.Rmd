...
Genome browser-style figures of SSD1 CRAC profiles. Focusing on only 30C rep A (`Ssd1_3_30`) and B (`Ssd1_4_30`). On a handful of landmark Ssd1-regulated genes.
...
```{r load_gff}
gff_Sc <- read_gff("~/Repos/yeastutrgff/out/gff_ncRNAs_abundantverifiedmRNAparts.gff") %>%
...
plot_8genes <- 
  plot_grid(SUN4_bg,SIM1_bg,UTH1_bg,SCW4_bg,CTS1_bg,DSE2_bg,CCW12_bg, SRL1_bg,ncol = 2)

plot_8genes

ggsave("figure/bedgraph-plot_8genes.pdf",plot_8genes,
       height=6,width=6)
```
