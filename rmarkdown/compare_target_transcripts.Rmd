...
This script also relies on lists of Ssd1-enriched transcripts from DESeq2 analysis produced by `deseq2_Ssd1_CRAC_vs_RNAseq.Rmd`, found in `results/Ssd1_targets_TPMratio4x_30C.txt`
...
ssd1_targets_bayne2020_30C <- 
    ...
    # filter(!is.na(Name)) %>%
    # pull(Gene)
  read_lines("../results/Ssd1_enrichment_DeSeq2_30C_2x_padj0p05_genesonly.txt")

ssd1_targets_bayne2020_42C <- 
    # ssd1_data_bayne2020_42C %>%
    # filter(!is.na(Name)) %>%
    # pull(Gene)
  read_lines("../results/Ssd1_enrichment_DeSeq2_42C_2x_padj0p05_genesonly.txt")
```
