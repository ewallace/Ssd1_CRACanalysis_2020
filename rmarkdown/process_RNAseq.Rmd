...
This script contains the code used to preprocess RNA-seq data measuring mRNA levels in conditions matched to CRAC experiments.

It begins at fastq files, and ends with a text-format coverage file on RNA transcripts: `RNAseq/allsample_transcriptcounts.txt`. 
...
with open("RNAseq/allsample_transcriptcounts.txt", "w") as outhandle:
	outhandle.write( "# allsample_transcriptcounts.txt - counts to transcripts from multiBamCov\n")
	outhandle.write( "# Run from normalise_Ssd1_CRAC_counts_vs_RNAseq.Rmd\n")
