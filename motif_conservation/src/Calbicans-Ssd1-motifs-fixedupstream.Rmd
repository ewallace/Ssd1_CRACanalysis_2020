...
id_file_CNYTCNYT1_up100 <- paste(here::here(), "results", "Ca_id_list_CNYTCNYT1_up100.txt", sep = "/")
CNYTCNYT_count_df %>%
    filter(count_up100 >= 1) %>%
    pull(id) %>%
    write_lines(file = id_file_CNYTCNYT1_up100)

id_file_CNYTCNYT2_up100 <- paste(here::here(), "results", "Ca_id_list_CNYTCNYT2_up100.txt", sep = "/")
CNYTCNYT_count_df %>%
